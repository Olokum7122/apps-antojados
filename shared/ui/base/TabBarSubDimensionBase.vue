...
const props = defineProps({
  ...
  level: { type: String, default: 'SUBTAB' },
...
const resolvedTabs = computed(() =>
  resolveBarItems(props.level || 'SUBTAB', props.tabs || [], {
...
const classes = computed(() => resolveBaseComponentClasses('subdimensionTabs', { grid: isGridLayout.value }))
