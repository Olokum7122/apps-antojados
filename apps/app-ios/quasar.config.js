    ...
    build: {
      ...
      extendViteConf (viteConf) {
        ...
        viteConf.resolve.alias = [
          ...
          { find: /^@capacitor\/app$/, replacement: resolve(__dirname, 'src-capacitor/node_modules/@capacitor/app/dist/esm/index.js') },
          { find: /^@capacitor\/haptics$/, replacement: resolve(__dirname, 'src-capacitor/node_modules/@capacitor/haptics/dist/esm/index.js') },
          { find: /^@capacitor\/preferences$/, replacement: resolve(__dirname, 'node_modules/@capacitor/preferences/dist/esm/index.js') },
          { find: /^@capacitor\/splash-screen$/, replacement: resolve(__dirname, 'src-capacitor/node_modules/@capacitor/splash-screen/dist/esm/index.js') },
          { find: /^@capacitor\/status-bar$/, replacement: resolve(__dirname, 'src-capacitor/node_modules/@capacitor/status-bar/dist/esm/index.js') },
